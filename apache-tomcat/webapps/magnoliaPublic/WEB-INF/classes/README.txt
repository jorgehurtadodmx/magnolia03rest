...
This package contains:
   ...
   Magnolia Core 6.2.20
   Magnolia empty webapp 6.2.20
   Magnolia empty webapp 6.2.20
   Magnolia Internationalization Framework 6.2.20
   Magnolia JAAS 6.2.20
   Magnolia Mail module 5.5.13
   magnolia-module-rssaggregator 2.6.4
   Magnolia Rendering 6.2.20
   Magnolia Templating 6.2.20
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/6.2.20.html
